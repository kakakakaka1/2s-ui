...
export default {
  ...
  setting: {
    ...
    trafficAge: "Thời gian lưu lịch sử lưu lượng",
    trafficAgeHint: "Ngày; 0 là không lưu lịch sử, hạn mức vẫn được tính",
  ...
  bulk: {
    resetPolicy: "Lịch đặt lại",
    resetPolicyOffHint: "Các khách hàng đã chọn sẽ không tự đặt lại nữa.",
    order: "Sắp xếp",
    random: "Ngẫu nhiên",
  ...
  types: {
    ...
    hy: {
      ...
      hopBothRequired: "Phải đặt cả hai khoảng nhảy; chỉ đặt giá trị tối đa sẽ bị từ chối khi client kết nối.",
      hopOrder: "Khoảng nhảy không được lớn hơn khoảng nhảy tối đa.",
      hopTooShort: "Khoảng nhảy tối thiểu là 5 giây.",
