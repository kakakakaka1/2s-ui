...
export default {
  ...
  setting: {
    ...
    trafficAge: "Traffic History Retention",
    trafficAgeHint: "Days; 0 keeps no history, quota is still counted",
  ...
  client: {
    ...
    nextResetHint: "Shifts this period only; the cycle stays. Leave empty to compute it from the cycle",
  ...
  bulk: {
    resetPolicy: "Reset schedule",
    resetPolicyOffHint: "The selected clients stop resetting automatically.",
    order: "Order",
    random: "Random",
  ...
  types: {
    ...
    hy: {
      ...
      hopBothRequired: "Set both hop intervals or neither: a max on its own is refused when the client dials.",
      hopOrder: "The hop interval must not be greater than the max hop interval.",
      hopTooShort: "A hop interval must be at least 5 seconds.",
