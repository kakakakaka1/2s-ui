...
export default {
  ...
  setting: {
    ...
    trafficAge: "Срок хранения истории трафика",
    trafficAgeHint: "Дней; 0 — история не хранится, квоты считаются",
  ...
  client: {
    ...
    nextResetHint: "Сдвигает только этот период, цикл не меняется; пусто — по циклу",
  ...
  bulk: {
    resetPolicy: "Расписание сброса",
    resetPolicyOffHint: "Выбранные клиенты перестанут сбрасываться автоматически.",
    order: "Порядок",
    random: "Случайный",
  ...
  types: {
    ...
    hy: {
      ...
      hopBothRequired: "Задайте оба интервала перехода: только максимум клиент отклонит при подключении.",
      hopOrder: "Интервал перехода не должен превышать максимальный.",
      hopTooShort: "Интервал перехода должен быть не менее 5 секунд.",
