...
export default {
  ...
  node: {
    ...
    import: "درون‌آیی‌ها",
    importOk: "درون‌آیی‌ها وارد شدند",
    reconcile: "همگام‌سازی",
    syncOk: "همگام‌سازی آغاز شد",
  ...
  setting: {
    ...
    behindProxyHint: "پنل روی HTTP می‌ماند؛ گواهی صادرشده برای استفاده پروکسی است",
    ...
    certForProxy: "گواهی: {cert}، کلید: {key}. این دو فایل را در ریورس پروکسی تنظیم کنید؛ پنل روی HTTP می‌ماند.",
    ...
    issueCertRestarting: "گواهی آماده است. پنل در حال راه‌اندازی مجدد و انتقال به HTTPS است…",
    ...
    webUriProxyHint: "پشت پروکسی الزامی است: پنل نمی‌تواند آدرس عمومی خود را تشخیص دهد و هدایت پس از راه‌اندازی مجدد به این مقدار وابسته است",
