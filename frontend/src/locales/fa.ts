...
export default {
  ...
  setting: {
    ...
    trafficAge: "مدت نگهداری تاریخچه ترافیک",
    trafficAgeHint: "روز؛ ۰ یعنی تاریخچه ذخیره نمی‌شود، سهمیه همچنان شمارش می‌شود",
    timeLoc: "منطقه زمانی",
    subEncode: "رمزگذاری",
  ...
  client: {
    ...
    nextResetHint: "فقط همین دوره را جابه‌جا می‌کند؛ چرخه تغییر نمی‌کند؛ خالی = محاسبه بر اساس چرخه",
  ...
  bulk: {
    resetPolicy: "زمان‌بندی بازنشانی",
    resetPolicyOffHint: "کاربران انتخاب‌شده دیگر به‌صورت خودکار بازنشانی نمی‌شوند.",
    order: "ترتیب",
    random: "تصادفی",
  ...
  types: {
    ...
    hy: {
      ...
      hopBothRequired: "هر دو بازهٔ پرش را با هم تنظیم کنید؛ تنها بیشینه، هنگام اتصال کلاینت رد می‌شود.",
      hopOrder: "بازهٔ پرش نباید از بیشینهٔ آن بزرگ‌تر باشد.",
      hopTooShort: "بازهٔ پرش دست‌کم باید 5 ثانیه باشد.",
