...
продлевать бесплатный сертификат Let's Encrypt — без certbot, без cron-задач. После
завершения панель будет доступна по адресу `https://<your-domain>:2095/app`.
...
`/etc/nginx/conf.d/s-ui-panel-<домен>.conf`, направленный на панель и с нужными
